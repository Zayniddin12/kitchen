      ...
      <div class="w-[70%]">
        <div class="border rounded-[24px] p-[24px]">
          <div class="grid grid-cols-3 gap-5">
            ...
            <app-input label="Наименование (UZ)" placeholder="Введите" label-class="text-[#A8AAAE] font-medium text-[12px]"/>

            <app-input label="Уникальный номер рациона" placeholder="Введите" label-class="text-[#A8AAAE] font-medium text-[12px]" disabled/>
          </div>
          ...
          <div class="grid grid-cols-3 gap-5">
           ...
           <div class="grid grid-cols-2">
            ...
            <app-input label="Длительность" placeholder="Введите" label-class="text-[#A8AAAE] font-medium text-[12px]"/>
          </div>
