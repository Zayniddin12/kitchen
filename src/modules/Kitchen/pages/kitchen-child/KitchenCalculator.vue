  ...
  <div>
    ...
    <div class="bg-[#FFFFFF] border border-[#E2E6F3] rounded-[24px] p-[24px]">
      ...
      <div class="flex items-center gap-4 w-[70%]">
        <app-select class="w-full" label="Рацион" label-class="text-[#A8AAAE] text-[12px] font-medium"
                    placeholder="Выберите рацион" />
        <app-input class="w-full" placeholder="Введите количество порций" label="Порция"
                   pla
