...
<template>
  <div>
    ...
    <div class="flex items-center justify-between">
      ...
      <button class="custom-cancel-btn flex items-center" @click="router.push(`/visitors-edit-form/${route.params.id}`)">
    ...
    <div class="border rounded-[24px] py-[32px] px-[24px] w-[50%] m-auto relative group" v-else>
      ...
      <img src="@/assets/images/bigMan.png" class="w-full group-hover:filter group-hover:brightness-50 transition duration-300 rounded-lg" alt="bigMan" />
    </div>
  </div>
</template>
