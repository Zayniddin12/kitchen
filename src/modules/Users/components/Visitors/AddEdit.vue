...
<template>
  <div>
    <h1 class="m-0 font-semibold text-[32px]">{{route.name === 'visitors-create-form' ? 'Добавить' : 'Редактировать'}}</h1>
    ...
    <div class="flex items-center justify-end mt-[24px]">
      <button class="custom-cancel-btn" @click="router.push('/visitors')">Отменить</button>
