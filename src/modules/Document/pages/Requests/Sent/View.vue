  ...
  <div class="flex items-start justify-center">
    <div class="w-[50%] mr-0">
      <div class="border-[#E2E6F3] border rounded-[15px]">
        <div class="px-[72px] pb-[70px]">
          ...
          <div class="flex items-center mb-[24px]">
            ...
            <span class="ml-2 text-[#A8AAAE] text-[14px] font-medium block">Z 04-04-01/463</span>
          </div>

          <div class="flex items-baseline mb-[24px]">
            <h1 class=" text-[14px] font-medium">
              <span class="text-[#4F5662]">Получатель:</span>
          ...
          <div class="flex items-center mb-[24px]">
            <h1 class="text-[#4F5662] text-[14px] font-medium">Тип запроса:</h1>
      ...
      <div class="flex items-center justify-end mt-[24px]">
        <button class="custom-danger-btn ml-[16px]">Отозвать</button>
      </div>
    </div>
