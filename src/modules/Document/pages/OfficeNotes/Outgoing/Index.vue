...
<template>
  <div>
    <div class="flex items-center justify-between">
      ...
      <button class="custom-filter-btn font-medium" :class="isOpenFilter ? '!bg-blue !text-white' : ''" @click="isOpenFilter = !isOpenFilter">
    ...
    <CollapseFilter v-model="isOpenFilter">
      <template #body>
        <div class="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-4">
          ...
          <app-date-picker placeholder="по эту дату" label="С этой даты" label-class="text-[#7F7D83]"/>
