...
<template>
  <div class="p-8 h-screen flex flex-col lg:flex-row items-center relative bg-[#ffffff]">
    ...
    <div class="w-full lg:w-1/4 md:w-1/2 m-auto">
      ...
      <h1 class="text-dark text-xl font-bold">Сброс пароля</h1>
      <p class="text-[#A8AAAE] text-[14px] mt-[6px] w-[90%]">
        На данной странице Вы можете восстановить доступ к своему аккаунту. Введите Ваш номер телефона и система автоматически отправит Вам временный
      ...
      <div class="text-[#8F9194] text-[14px] text-center"  v-if="userData.phone.length === 13">
        {{count}}
      </div>
